                        ...
                        children: [
                          Column(
                            children: [
                              GestureDetector(
                                onTap: () {
                                  viewModel.setSelectTitle();
                                },
                                child: Container(
                                    width: double.infinity,
                                    height: cartazHeight * 0.25,
                                    child: LineWidget(
                                        line: viewModel.title,
                                        isSelected: viewModel.selectTitle == true)),
                              ),

                              ...viewModel.content.asMap().entries.map((entry) {
                                ...
                                return GestureDetector(
                                  ...
                                  child: LineWidget(
                                      line: line,
                                      isSelected:
                                          viewModel.selectedLineIndex == index),
                                );
                              }).toList(),
